...
void Renderer::BuildImGuiUI() {
    ...
    if (CharIsForwardPBR()) {
        ...
        if (!m_efFaceSdf) {
            ImGui::SliderFloat("Face flatness", &m_efFaceFloor, 0.0f, 1.0f);
            ImGui::SameLine(); ImGui::TextDisabled("(1 = flat/bright, lower = shaded like body)");
        }
